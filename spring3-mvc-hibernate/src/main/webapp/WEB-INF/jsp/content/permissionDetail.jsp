...
<form:form method="post" action="addOrUpdatePermission.do" commandName="permission">
	...
	<table class="table">
		...
		<tr>
			<td><input class="btn btn-primary" type="submit" value="<spring:message code="label.addorupdatepermission"/>" /></td>
			<td>&nbsp;</td>
			<td>&nbsp;</td>
		</tr>
	</table>
